...
ROUND_START = '¡Comenzo la ronda de CTF! Finaliza en {time}'
ROUND_END = '{name} gano la ronda con {points} puntos!'
SCORE_POINT = '{name} anoto un punto!'
TAKE_FLAG = '{name} tomo una bandera!'
DROP_FLAG = '{name} solto la bandera!'
NEXT_ROUND = 'La proxima ronda comienza en {time}'
NOT_PLACING = 'No se esta colocando ninguna entidad'
