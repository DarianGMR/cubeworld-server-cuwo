...
APPEARANCES = dict({
    2: {'scale': 0.96,
        ...
        'scale_wing': 1.00,
        'scale_unknown': 1.00,
        'offset_body': vec3(0, 0, -5),
        'offset_head': vec3(0, 0.5, 5),
        'offset_hand': vec3(6, 0, 0),
        'offset_foot': vec3(3, 1, -10.5),
        'offset_back': vec3(0, -8, 2),
        'offset_wing': vec3(0, 0, 0),
        'model_head': list(range(1246, 1251 + 1)),
        'model_hair': list(range(1252, 1266 + 1)),
        'model_feet': (432, ),
        'model_hand': (430, 431),
        'model_body': (1, ),
        'model_back': (-1, ),
    ...
    3: {'scale': 0.96,
        ...
        'offset_back': vec3(0, -8, 2),
        'offset_wing': vec3(0, 0, 0),
        'model_head': list(range(1267, 1272 + 1)),
        'model_hair': list(range(1273, 1279 + 1)),
        'model_feet': (432, ),
        'model_hand': (430, 431),
        'model_body': (1, ),
        'model_back': (-1, ),
    ...
    0: {'scale': 0.96,
        ...
        'offset_back': vec3(0, -8, 2),
        'offset_wing': vec3(0, 0, 0),
        'model_head': list(range(1236, 1239 + 1)),
        'model_hair': list(range(1280, 1289 + 1)),
        'model_feet': (432, ),
        'model_hand': (430, ),
        'model_body': (1, ),
        'model_back': (-1, ),
    ...
    1: {'scale': 0.96,
        ...
        'offset_back': vec3(0, -8, 2),
        'offset_wing': vec3(0, 0, 0),
        'model_head': list(range(1240, 1245 + 1)),
        'model_hair': list(range(1290, 1299 + 1)),
        'model_feet': (432, ),
        'model_hand': (430, ),
        'model_body': (0, ),
        'model_back': (-1, ),
    ...
    9: {'scale': 0.80,
        'radius': 0.80,
        'height': 1.80,
        'model_head': list(range(282, 286 + 1)),
        'model_hair': list(range(287, 289 + 1)),
        'model_hand': (430, 431),
        'model_feet': (432,),
        'model_body': (300,),
        'model_back': (-1,),
    ...
    10: {'scale': 0.80,
         'radius': 0.80,
         'height': 1.80,
         'model_head': list(range(290, 294 + 1)),
         'model_hair': list(range(295, 299 + 1)),
         'model_hand': (430, 431),
         'model_feet': (432,),
         'model_body': (301,),
         'model_back': (-1,),
    ...
    11: {'scale': 1.04,
         'radius': 1.04,
         'height': 2.34,
         'model_head': list(range(1300, 1304 + 1)),
         'model_hair': list(range(1310, 1319 + 1)),
         'model_hand': (302,),
         'model_feet': (432,),
         'model_body': (0,),
         'model_back': (-1,),
    ...
    12: {'scale': 1.04,
         'radius': 1.04,
         'height': 2.34,
         'model_head': list(range(1305, 1309 + 1)),
         'model_hair': list(range(1320, 1323 + 1)),
         'model_hand': (302,),
         'model_feet': (432,),
         'model_body': (0,),
         'model_back': (-1,),
         ...
         'scale_unknown': 1.20,
         'offset_body': vec3(0, 0, -5),
         'offset_head': vec3(0.00, 1.50, 4.00),
         'offset_hand': vec3(6, 0, 0),
         'offset_foot': vec3(3, 1, -10.5),
         'offset_back': vec3(0, -8, 2),
         'offset_wing': vec3(0, 0, 0)},
    ...
    4: {'scale': 0.80,
        'radius': 0.80,
        'height': 1.80,
        'model_head': list(range(75, 79 + 1)),
        'model_hair': list(range(80, 85 + 1)),
        'model_hand': (97,),
        'model_feet': (432,),
        'model_body': (0,),
        'model_back': (-1,),
    ...
    5: {'scale': 0.80,
        'radius': 0.80,
        'height': 1.80,
        'model_head': list(range(86, 90 + 1)),
        'model_hair': list(range(91, 96 + 1)),
        'model_hand': (97,),
        'model_feet': (432,),
        'model_body': (0,),
        'model_back': (-1, ),
    ...
    7: {'scale': 0.96,
        'radius': 0.96,
        'height': 2.16,
        'model_head': list(range(98, 99 + 1)),
        'model_hair': list(range(100, 105 + 1)),
        'model_hand': (111,),
        'model_feet': (113,),
        'model_body': (112,),
        'model_back': (-1,),
    ...
    8: {'scale': 0.96,
        'radius': 0.96,
        'height': 2.16,
        'model_head': list(range(106, 111 + 1)),
        'model_hair': list(range(100, 105 + 1)),
        'model_hand': (111,),
        'model_feet': (113,),
        'model_body': (112,),
    ...
    15: {'scale': 0.96,
         'radius': 0.96,
         'height': 2.16,
         'model_hair': list(range(309, 314 + 1)),
         'model_head': list(range(303, 308 + 1)),
         'model_hand': (327,),
         'model_feet': (432,),
         'model_body': (0,),
         'model_back': (-1,),
    ...
    16: {'scale': 0.96,
         'radius': 0.96,
         'height': 2.16,
         'model_hair': list(range(321, 326 + 1)),
         'model_head': list(range(315, 320 + 1)),
         'model_hand': (327, ),
         'model_feet': (432, ),
         'model_body': (0, ),
         'model_back': (-1, ),
    ...
    13: {'scale': 0.96,
         'radius': 0.96,
         'height': 2.16,
         'model_head': list(range(1324, 1328 + 1)),
         'model_hair': list(range(1329, 1333 + 1)),
         'model_hand': (1342, ),
         'model_feet': (432, ),
         'model_body': (1, ),
         'model_back': (-1, ),
    ...
    14: {'scale': 0.96,
         'radius': 0.96,
         'height': 2.16,
         'model_head': list(range(1334, 1337 + 1)),
         'model_hair': list(range(1338, 1341 + 1)),
         'model_hand': (1342, ),
         'model_feet': (432, ),
         'model_body': (1, ),
         'model_back': (-1, ),
