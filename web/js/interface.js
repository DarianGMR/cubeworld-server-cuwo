                ...
                if (data.bans.length === 0) {
                    ...
                    data.bans.forEach(ban => {
                        ...
                        if (existingBan.length > 0) {
                            ...
                            const currentReason = existingBan.find('[data-field="reason"]').text();
                            const currentBannedBy = existingBan.find('[data-field="banned_by"]').text();
                            
                            if (currentName !== (ban.name || 'Desconocido') || 
                                currentReason !== (ban.reason || 'Sin razon') ||
                                currentBannedBy !== (ban.banned_by || 'administrador')) {
                                existingBan.find('.ban-name').text(ban.name || 'Desconocido');
                                existingBan.find('[data-field="reason"]').text(ban.reason || 'Sin razon');
                                existingBan.find('[data-field="banned_by"]').text(ban.banned_by || 'administrador');
                            }
                        } else {
                                    ...
                                    <div class="ban-info">
                                        ...
                                        <div class="ban-details-row">
                                            <div class="ban-detail-item">
                                                ...
                                                <span class="ban-detail-value" data-field="ip">${ban.ip}</span>
                                            </div>
                                            <div class="ban-detail-item">
                                                <span class="ban-detail-label">POR</span>
                                                <span class="ban-detail-value" data-field="banned_by">${ban.banned_by || 'administrador'}</span>
                                            </div>
                                            <div class="ban-detail-item">
                                                <span class="ban-detail-label">Razon</span>
                                                <span class="ban-detail-value" data-field="reason">${ban.reason || 'Sin razon'}</span>
                                            </div>
                                        </div>
                                    </div>
